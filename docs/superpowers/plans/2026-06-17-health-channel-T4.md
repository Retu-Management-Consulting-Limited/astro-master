...
- [ ] `todayVerdict` 扩成双轨：算财运 verdict + 身心 verdict，按强度选**主导 channel**（`channel: '钱'|'健康'`），主导那条当今日格主体；另一条进 chip。身心判词：能量态主句（安抚/permission）+ 内在 why（怎么待自己）+ 自我照顾许可 + **症状自证微互动** + （慢相位稀有时）转专业。
- [ ] **守 charter 硬约束**：身心文案 **说倾向不说病**（症状她自证得了；病种/诊断禁）；真信号 → 转专业（看医生）兜底。state 仍belief-无关（沿 edge-preservation）。
